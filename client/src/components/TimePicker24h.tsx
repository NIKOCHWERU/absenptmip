  ...
  return (
    <div ref={containerRef} className="relative inline-block w-full">
      ...
      <button
        ...
        className={cn(
          "flex items-center justify-between gap-2 px-3 py-2 border rounded-xl bg-white hover:bg-gray-50/80 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all text-xs font-mono font-bold text-gray-800 shadow-sm w-full h-10 cursor-pointer",
          className
        )}
      >
      ...
      {/* 2-Column Popup (No AM/PM, Max 24 Hours) */}
      {open && (
        <div className="absolute left-0 top-12 z-50 w-64 p-3 rounded-2xl shadow-2xl border border-gray-200 bg-white animate-in fade-in-0 zoom-in-95">
          {/* Header Display */}
          <div className="flex items-center justify-between pb-2 mb-2 border-b border-gray-100">
            <div className="flex items-center gap-1.5">
              <Clock className="w-4 h-4 text-blue-600" />
              <span className="text-xs font-bold text-gray-800">Format 24 Jam</span>
            </div>
          ...
          {/* 2 Scrollable Columns: Jam & Menit */}
          ...
          {/* Manual Text Input & Confirm Button */}

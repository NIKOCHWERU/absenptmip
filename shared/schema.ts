...
export const users = mysqlTable("users", {
  ...
  kkNumber: varchar("kk_number", { length: 50 }),
  kkPhotoUrl: varchar("kk_photo_url", { length: 512 }),
...
export const overtimes = mysqlTable("overtimes", {
  ...
  status: mysqlEnum("status", ["pending", "ongoing", "completed", "cancelled"]).default("pending"),
  employeeApproval: mysqlEnum("employee_approval", ["pending", "approved", "rejected"]).default("pending"),
